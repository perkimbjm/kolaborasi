...
// Submit to google spreadsheet Pokir
const scriptURLPokir = 'https://script.google.com/macros/s/AKfycbySOkyQv3kwiLfbx9lwH3BtV45i3ncYENeLFExd0YvDz7FcKJucXqUapmcaY2oDkoI/exec';
const form3 = document.forms['verif-pokir'];
const btnSimpan3 = document.querySelector('.btn-simpan3');
const btnLoading3 = document.querySelector('.btn-loading3');
const myAlert3 = document.querySelector('.my-alert3');

form3.addEventListener('submit', event => {
  event.preventDefault();
  btnSimpan3.classList.toggle('d-none');
  btnLoading3.classList.toggle('d-none');
  fetch(scriptURLPokir, { mode: 'no-cors', method: 'POST', body: new FormData(form3)})
    .then(response => {
      console.log('Success!', response);
      btnSimpan3.classList.toggle('d-none');
      btnLoading3.classList.toggle('d-none');
      myAlert3.classList.toggle('d-none');
      form3.reset();
    })
